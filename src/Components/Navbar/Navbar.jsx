            ...
            <div className="navbar bg-gray-400 shadow-sm">
                <div className="navbar-start">
                    <div className="dropdown -ms-3">
                        ...
                        <ul
                            tabIndex="-1"
                            className="menu menu-sm dropdown-content bg-linear-to-r from-gray-200 to-sky-600 text-semibold rounded-box z-1 mt-3 w-52 p-2 shadow">
                            {list}
                        </ul>
                    </div>
                    <Link to="/" className="text-md md:text-xl -ml-2 md:ml-4 font-bold">Smart Deals</Link>
                </div>
                ...
                <div className="navbar-end">
                    <p className='pr-0.5 md:pr-4 text-xs md:text-lg'>{user?.email}</p>
                    {
                        user ?
                            ...
                            :
                            <Link to="/signin" className="btn btn-soft btn-secondary">Log In</Link>
